...
let s:cfg_interface = [
 \ ['<Leader>n',       '&Next',                   'DBGRnext()'],
 \ ['<Leader>i',       '&Step in',                'DBGRstep()'],
 \ ['<Leader>o',       'Step &out',               'DBGRstepout()'],
 \ ['<Leader>c',       '&Continue',               'DBGRcont()'],
 \ ['<Leader>b',  'Set &breakpoint',         'DBGRsetBreakPoint()'],
 \ ['<Leader>bb',  'C&lear breakpoint',       'DBGRclearBreakPoint()'],
 \ ['<Leader>B', 'Clear &all breakpoints',  'DBGRclearAllBreakPoints()'],
 ...
 \ ['<Leader>r',      '&Restart',                'DBGRrestart()'],
 \ ['<Leader>q',      '&Quit',                   'DBGRquit()'],
\]
